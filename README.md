...
* [Detecting Anomalous Event Sequences with Temporal Point Processes](https://arxiv.org/abs/2106.04465) [NeurIPS-2021] [![GitHub Repo stars](https://img.shields.io/github/stars/shchur/tpp-anomaly-detection?style=social)](https://github.com/shchur/tpp-anomaly-detection) 
...
* [Temporal Logic Point Processes](https://proceedings.mlr.press/v119/li20p.html) [ICLR-2020]
...
* [Learning registered point processes from idiosyncratic observations](http://people.ee.duke.edu/~lcarin/Hongteng_ICML18.pdf) [ICML-2018] 
...
* [TemporalPointProcessPapers](https://github.com/yangalan123/TemporalPointProcessPapers)
